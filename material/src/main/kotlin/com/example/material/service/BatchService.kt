...
interface BatchService {
     ...
     */
    suspend fun getBatchBySpecificationFuzzy(specification: String): Flow<MaterialBatch>

    suspend fun insertBatchDTO(batch: MaterialBatchDTO): UUID
    suspend fun updateBatchDTO(batch: MaterialBatchDTO): Boolean
}